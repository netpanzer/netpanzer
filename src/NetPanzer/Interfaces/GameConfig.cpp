...
int GameConfig::interface_unitselectionmode =
...
int GameConfig::interface_viewdrawbackgroundmode =
    (int)VIEW_BACKGROUND_DARK_GRAY_BLEND;
...
static const ScriptVarBindRecord interface_getters[] = {
    ...
    {"attacknotificationime", GETSVTYPE_INT,
     &GameConfig::interface_attacknotificationtime},
    {"vehicleselectioncolor", GETSVTYPE_INT,
     &GameConfig::interface_vehicleselectioncolor},
    {"unitselectionmode", GETSVTYPE_INT,
     &GameConfig::interface_unitselectionmode},
    {"unitinfodrawlayer", GETSVTYPE_INT,
    ...
    {"viewdrawbackgroundmode", GETSVTYPE_INT,
     &GameConfig::interface_viewdrawbackgroundmode},
    {0, 0}};
...
static const ScriptVarBindRecord interface_setters[] = {
    ...
    {"attacknotificationime", SETSVTYPE_INT,
     &GameConfig::interface_attacknotificationtime},
    {"vehicleselectioncolor", SETSVTYPE_INT,
     &GameConfig::interface_vehicleselectioncolor},
    {"unitselectionmode", SETSVTYPE_INT,
     &GameConfig::interface_unitselectionmode},
    {"unitinfodrawlayer", SETSVTYPE_INT,
     &GameConfig::interface_unitinfodrawlayer},
    ...
    {"viewdrawbackgroundmode", SETSVTYPE_INT,
     &GameConfig::interface_viewdrawbackgroundmode},
    {0, 0}};
...
static const ScriptVarBindRecord game_getters[] = {
    ...
    {"occupationpercentage", GETSVTYPE_INT,
    ...
    //{ "authentication",     GETSVTYPE_BOOLEAN,
    //&GameConfig::game_authentication }, { "bots_allowed", GETSVTYPE_BOOLEAN,
    //&GameConfig::game_bots_allowed }, { "scrambler", GETSVTYPE_BOOLEAN,
    //&GameConfig::game_scrambler }, { "maxchatlines",       GETSVTYPE_INT,
    //&GameConfig::game_maxchatlines },
...
static const ScriptVarBindRecord game_setters[] = {
    ...
    {"occupationpercentage", SETSVTYPE_INT,
     &GameConfig::game_occupationpercentage},
    ...
    //{ "authentication",     SETSVTYPE_BOOLEAN,
    //&GameConfig::game_authentication }, { "bots_allowed", SETSVTYPE_BOOLEAN,
    //&GameConfig::game_bots_allowed }, { "scrambler", SETSVTYPE_BOOLEAN,
    //&GameConfig::game_scrambler }, { "maxchatlines",       SETSVTYPE_INT,
    //&GameConfig::game_maxchatlines },
...
static const ScriptVarBindRecord radar_getters[] = {
    ...
    {"playeroutpostcolor", GETSVTYPE_INT,
     &GameConfig::radar_playeroutpostcolor},
    {"alliedoutpostcolor", GETSVTYPE_INT,
     &GameConfig::radar_alliedoutpostcolor},
...
static const ScriptVarBindRecord radar_setters[] = {
    ...
    {"playeroutpostcolor", SETSVTYPE_INT,
     &GameConfig::radar_playeroutpostcolor},
    {"alliedoutpostcolor", SETSVTYPE_INT,
     &GameConfig::radar_alliedoutpostcolor},
...
static const ScriptVarBindRecord server_getters[] = {
    ...
    {"interactive_console", GETSVTYPE_BOOLEAN,
     &GameConfig::server_interactive_console},
    ...
    {"command_burst_limit", GETSVTYPE_INT,
...
static const ScriptVarBindRecord server_setters[] = {
    ...
    {"interactive_console", SETSVTYPE_BOOLEAN,
     &GameConfig::server_interactive_console},
    ...
    {"command_burst_limit", SETSVTYPE_INT,
     &GameConfig::server_command_burst_limit},
    {0, 0}};

static const ScriptVarBindRecord player_getters[] = {
    {"name", GETSVTYPE_STRING, &GameConfig::player_name}, {0, 0}};

static const ScriptVarBindRecord player_setters[] = {
    {"name", SETSVTYPE_STRING, &GameConfig::player_name}, {0, 0}};
...
void GameConfig::registerScript(const NPString& table_name) {
  ...
  ScriptManager::bindStaticVariables(table_name + ".video",
                                     "ConfigVideoMetaTable", video_getters,
                                     video_setters);
  ...
  ScriptManager::bindStaticVariables(
      table_name + ".game", "ConfigGameMetaTable", game_getters, game_setters);

  ScriptManager::bindStaticVariables(table_name + ".sound",
                                     "ConfigSoundMetaTable", sound_getters,
                                     sound_setters);

  ScriptManager::bindStaticVariables(table_name + ".radar",
                                     "ConfigRadarMetaTable", radar_getters,
                                     radar_setters);
  ...
  ScriptManager::bindStaticVariables(table_name + ".server",
                                     "ConfigServerMetaTable", server_getters,
                                     server_setters);

  ScriptManager::bindStaticVariables(table_name + ".player",
                                     "ConfigPlayerMetaTable", player_getters,
                                     player_setters);

  ScriptManager::bindStaticVariables(table_name + ".bot", "ConfigBotMetaTable",
...
void GameConfig::saveConfig() {
  ...
  if (!lua_isfunction(L, -1)) {
    LOGGER.warning(
        "ERROR: Can't save configuration, config.dump function doesn't exist.");
    lua_pop(L, 2);
    return;
  }
  ...
  if (lua_pcall(L, 1, 1, 0)) {
    LOGGER.warning("ERROR: Can't save configuration, Lua error: '%s'",
                   lua_tostring(L, -1));
    lua_pop(L, 1);
    return;
  }
  ...
  if (!lua_isstring(L, -1)) {
    LOGGER.warning(
        "ERROR: Can't save configuration, dump result is not a string.");
    lua_pop(L, 1);
    return;
  }

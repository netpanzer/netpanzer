...
void Weapon::init() {
  // packFiles();
  gMissleMediumPackedSurface.load(
      "pics/particles/missles/pak/misslesMedium.pak");
  ...
  gMissleGroundLightPackedSurface.load(
      "pics/particles/lights/pak/missleGroundLight.pak");
}

void Weapon::uninit() {
  // packFiles();
  gMissleMediumPackedSurface.unload(
      "pics/particles/missles/pak/misslesMedium.pak");
  gMissleSmallPackedSurface.unload(
      "pics/particles/missles/pak/misslesSmall.pak");
  gShellPackedSurface.unload("pics/particles/shells/pak/shells.pak");
  gMissleThrustPackedSurface.unload(
      "pics/particles/lights/pak/missleThrust.pak");
  gMissleGroundLightPackedSurface.unload(
      "pics/particles/lights/pak/missleGroundLight.pak");
}

Weapon::Weapon(UnitID owner, unsigned short owner_type_id,

...
enum {
  _net_message_id_connect_join_game_request,
...
enum {
  _connect_state_message_load_game_data,
...
class ConnectMesgNetPanzerClientDisconnect : public NetMessage {
 ...
 public:
  ...
  void setPlayerID(PlayerID id) { player_id = id; }

...
class SelectionBoxSprite : public Sprite {
 ...
 public:
  ...
  inline void setBoxState(bool on_off) { box_state = on_off; }
...
class UnitSelectionBox : public SelectionBoxSprite {
 ...
 public:
  ...
  inline void setAllieState(bool is_allied) { allie_state = is_allied; }

  inline void setName(std::string name) { playerName = name; }

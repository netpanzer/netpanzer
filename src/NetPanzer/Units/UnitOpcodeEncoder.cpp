...
UnitOpcodeEncoder::UnitOpcodeEncoder() { reset(); }

UnitOpcodeEncoder::~UnitOpcodeEncoder() {}

void UnitOpcodeEncoder::reset() { opcode_index = 0; }

void UnitOpcodeEncoder::encode(const UnitOpcode *opcode) {
...
void UnitOpcodeEncoder::send() {
  if (!opcode_index) return;

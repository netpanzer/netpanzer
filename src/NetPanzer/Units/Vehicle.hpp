...
enum { _aiFsmDefendHold_search_for_enemy, _aiFsmDefendHold_attack_enemy };
...
enum { _external_event_null, _external_event_pending_unit_destruct };
...
class Vehicle : public UnitBase {
 protected:
  ...
  unsigned short shortestRotation(AngleInt& angle, long goal_angle,
                                  long* delta);
 ...
 public:
  Vehicle(bool liveornot, PlayerState* player, unsigned char utype, UnitID id,
  ...
  /*
      static void updateLiveUnitState(UnitID id, unsigned short orientation,

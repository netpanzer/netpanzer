...
HostView::HostView() : HostJoinTemplateView() {
  ...
  // addButtonCenterText(iXY(x, y), buttonXSize, "Objective", "",
  // setGameTypeObjective);

  // x += buttonXSize;
  // addButtonCenterText(iXY(x, y), buttonXSize, "Frag Limit", "",
  // setGameTypeFragLimit); addButton(iXY(x + buttonXSize + 1, y), "+", "",
  // increaseFragLimit); addButton(iXY(x + buttonXSize + 15, y), "-", "",
  // decreaseFragLimit);

  // x += buttonXSize;
  // addButtonCenterText(iXY(x, y), buttonXSize, "Time Limit", "",
  // setGameTypeTimeLimit); addButton(iXY(x + buttonXSize + 1, y), "+", "",
  // increaseTimeLimit); addButton(iXY(x + buttonXSize + 15, y), "-", "",
  // decreaseTimeLimit);

...
Button::Button(const std::string &cname) : Component("Button." + cname) {
...
Button *Button::createTextButton(std::string cname, std::string label, iXY loc,
                                 int bwidth) {
...
Button *Button::createSpecialButton(std::string cname, std::string label,
                                    iXY loc) {
  Surface bnormal;
...
{
    Surface bnormal;
    //std::string bnormal_str =
"pics/backgrounds/menus/buttons/default/US/"+label+".bmp"; std::string
bnormal_str =  "pics/backgrounds/menus/buttons/default/USB/"+label+".bmp"; const
char * cc_bnormal_str = bnormal_str.c_str(); bnormal.loadBMP(cc_bnormal_str);
//button

    Surface bhover;
    //std::string bhover_str =
"pics/backgrounds/menus/buttons/default/US-Hover/"+label+".bmp"; std::string
bhover_str =  "pics/backgrounds/menus/buttons/default/USB-Hover/"+label+".bmp";
    const char * cc_bhover_str = bhover_str.c_str();
    bhover.loadBMP(cc_bhover_str); //button1

    Surface bclick;
    //std::string bclick_str =
"pics/backgrounds/menus/buttons/default/US-Hover/"+label+".bmp"; std::string
bclick_str =  "pics/backgrounds/menus/buttons/default/USB-Hover/"+label+".bmp";

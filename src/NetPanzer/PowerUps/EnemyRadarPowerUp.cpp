...
void ActivateRadar() {
  ...
  ConsoleInterface::postMessage(Color::unitAqua, false, 0,
                                "YOU GOT AN ENEMY RADAR POWERUP");
}

bool EnemyRadarPowerUp::isRadarActive() {
...
void EnemyRadarPowerUp::onHit(UnitID unit_id) {
...
void EnemyRadarPowerUp::onHitMessage(PowerUpHitMesg* message) {
  sound->playPowerUpSound();
